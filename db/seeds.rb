...
Student.create(img_url: "app/assets/images/profiles/...", first_name: "Chief", last_name: "Keef", DOB: Date.parse("1995-7-17"), edu_level: "youngn", admin_id: 1, email: "keefgood@thetrampoline.com", password: "thatshitidontlike")

### Jason Bourne's instructors
Instructor.create(img_url: "app/assets/images/profiles/...", first_name: "John", last_name: "Gotti", DOB: Date.parse("1958-1-11"), edu_level: "streets", expertise: "takin out bosses", position: "Teflon Don", hire_date: Date.parse("2018-5-2"), salary: 50000000, admin_id: 1, email: "gottiboyz@thetrampoline.com", password: "teflondon")



### James Bond's students
Student.create(img_url: "app/assets/images/profiles/...", first_name: "Young", last_name: "Dro", DOB: Date.parse("1985-2-14"), edu_level: "HS", admin_id: 2, email: "dropurp@hotmail.com", password: "youngndro")
Student.create(img_url: "app/assets/images/profiles/...", first_name: "Blu", last_name: "DaVinci", DOB: Date.parse("1988-8-24"), edu_level: "Bachelors", admin_id: 2, email: "bluesocks@gmail.com", password: "cccccccrrrip")

### James Bond's instructors
Instructor.create(img_url: "app/assets/images/profiles/...", first_name: "Marylin", last_name: "Monroe", DOB: Date.parse("1946-4-1"), edu_level: "PHD", expertise: "suckin nuts", position: "Instructor 1", hire_date: Date.parse("2018-1-23"), salary: 50000, admin_id: 2, email: "marylinlove@thetrampoline.com", password: "prettygal2")
Instructor.create(img_url: "app/assets/images/profiles/...", first_name: "Tom", last_name: "Cruise", DOB: Date.parse("1968-10-18"), edu_level: "Bachelors", expertise: "actin a fool", position: "Instructor 2", hire_date: Date.parse("2018-2-2"), salary: 75000, admin_id: 2, email: "cruiseorsurf@thetrampoline.com", password: "moviesareus")



### instructor applicants
InstructorApplicant.create(img_url: "app/assets/images/profiles/...", first_name: "John", last_name: "Dough", DOB: Date.parse("1985-7-17"), edu_level: "Masters", email: "jonjohn@gw.com", password: "johnthegreat")
InstructorApplicant.create(img_url: "app/assets/images/profiles/...", first_name: "Lisa", last_name: "Lowitz", DOB: Date.parse("1991-10-28"), edu_level: "Bachelors", email: "ladylow@gmail.com", password: "lowlow23")

### student applicans
StudentApplicant.create(img_url: "app/assets/images/profiles/...", first_name: "Leo", last_name: "DiCaprio", DOB: Date.parse("1974-10-8"), edu_level: "Bachelors", email: "titanic1@gmail.com", password: "watchtv")
StudentApplicant.create(img_url: "app/assets/images/profiles/...", first_name: "Andy", last_name: "Garcia", DOB: Date.parse("1991-6-13"), edu_level: "Bachelors", email: "homerunking@hotmail.com", password: "baseball4life")
